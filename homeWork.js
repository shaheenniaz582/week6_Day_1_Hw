...
const changeMurderer = function() {
  murderer = 'Mrs. Peacock'; // you cant change murderer
}
...
changeMurderer(); //error
const verdict = declareMurderer(); // The murderer is Professor Plum
...
console.log('Second Verdict: ', secondVerdict);// The murderer is Professor Plum
Episode 4
...
changeWeapon('Revolver'); // scenario.weapon = Revolver
